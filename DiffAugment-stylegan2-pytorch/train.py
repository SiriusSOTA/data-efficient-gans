...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        'custom_low_shot':  dict(ref_gpus=-1, kimg=800,    mb=8,  mbstd=4,  fmaps=0.5, lrate=1e-6,   gamma=10,   ema=10,  ramp=None, map=2, snap=10),
...
# Base config.
@click.option('--cfg', help='Base config [default: low_shot]', type=click.Choice(['custom_low_shot', 'low_shot', 'auto', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar']))
...
@click.option('--diffaugment-placement', help='Comma-separated list of DiffAugment applying placement [default: real,generated,backprop]', type=str)
